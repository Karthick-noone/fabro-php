  ...
  ?> 
   ...
   <section class="gallery-section spad">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="gallery-item set-bg" data-setbg="admin/finimg/htlrpg.jpg">
                            <div class="gi-text">
                                <h3>Room premium</h3>
                            </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="gallery-item set-bg" data-setbg="admin/finimg/htuudq.jpg">
                                <div class="gi-text">
                                    <h3>Room premium</h3>
                                </div>
                            </div>
                ...
                <div class="col-lg-6">
                    <div class="gallery-item large-item set-bg" data-setbg="img/about/p5.jpg">
                        <div class="gi-text">
                            <h3>Room premium</h3>
                        </div>
                    </div>
