...
<body>
    <div class="container">
        <a href="gallery.php"><button class="back-button mt-5">
    ...
    try {
        ...
        $sql = "SELECT id, bg_photo FROM gallery"; // Include the ID in the query
        ...
        foreach ($images as $index => $imageData) {
            echo '<img class="thumbnail" data-id="' . $imageData['id'] . '" src="../images/gallery_images/' . $imageData['bg_photo'] . '" alt="Image ' . ($index + 1) . '">';
        }
    ...
    ?>
        ...
        <form id="delete-form" method="post" action="deleteImages1.php">
    ...
    <script>
        function uploadImage() {
            ...
            formData.append('wallpaper1', fileInput.files[0]);
