...
require_once(__DIR__ . '/class/logbase1.php');
 ...
 -->
    ...
    <script>
        ...
        async function fetchRoomPrices() {
            try {
                const response = await fetch('http://localhost/fabrorooms/booking/admin/price.php?action=fetchRoomPrices');
    ...
    <ul class="pagination">
        ...
        echo "<li><a href='dashboard.php?page=" . max(1, $page - 1) . "'" . ($page == 1 ? " class='disabled'" : "") . ">&lt;</a></li>";

        // Display numbered pages
        for ($i = 1; $i <= $total_pages; $i++) {
            echo "<li><a href='dashboard.php?page=" . $i . "'" . ($i == $page ? " class='active'" : "") . ">" . $i . "</a></li>";
        }

        // Show "Next" button
        echo "<li><a href='dashboard.php?page=" . min($total_pages, $page + 1) . "'" . ($page == $total_pages ? " class='disabled'" : "") . ">&gt;</a></li>";
        ?>
    </ul>
