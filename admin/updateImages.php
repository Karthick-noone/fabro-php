...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_FILES['wallpaper'])) {
        ...
        if ($file['error'] === UPLOAD_ERR_OK) {
            ...
            $stmt = $conn->prepare("INSERT INTO picture (bg_photo, imagepath) VALUES (?, ?)");
...
$sql = "SELECT bg_photo FROM picture"; // Replace with your actual query
