...
.edit-form {
        ...
        .image-preview img {
            max-width: 70%; /* Ensure the image fits within its container */
  ...
  <div class="back-button-box">
    ...
    <span class="back-button-elem">
      <svg viewBox="0 0 46 40">
       ...
       <center><h2>Edit Image</h2></center> 
        <?php
        ...
        <form action="up_wall1.php" method="post" enctype="multipart/form-data" class="edit-form">
