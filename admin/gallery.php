        ...
        <div class="container-fluid">
          <div class="row justify-content-between align-items-center">
            ...
            <div class="col-12 col-md-9  mb-3 mb-md-0">
              <h1 class="text-dark text-center my-5 " style="margin-left:300px">Gallery Images</h1>
            </div>
            <div class="col-12 col-md-3">
              <div class="dropdown" id="dropdown1">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                  ...
                  <a class="dropdown-item" href="add_slider_image1.php">Add Image</a>
                  <a class="dropdown-item" href="wallpaper1.php">Delete Image</a>
          ...
          <div class="row">
            ...
            if ($stmt) {
              ...
              foreach ($images as $row) {
                ...
                echo '<img src="../images/gallery_images/' . $imagePath . '" alt="" class="gallery-image img-fluid" width="400px" height="400px">';

                echo '<a style="text-decoration: none;" href="wall_change1.php?id=' . $id . '&image=../images/gallery_images/' . $imagePath . '&imagepath=' . $imagePathh . '">';
                echo '<br>';
